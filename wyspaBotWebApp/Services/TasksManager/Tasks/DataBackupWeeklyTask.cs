...
namespace wyspaBotWebApp.Services.TasksManager.Tasks {
    public class DataBackupWeeklyTask : IWeeklyTask {
        private readonly ILogger logger = LogManager.GetCurrentClassLogger();

        public DateTime TimeOfDay => new DateTime(DateTime.Now.Year, 1, 1, 12, 00, 0);

        public DayOfWeek DayOfTheWeek => DayOfWeek.Monday;
